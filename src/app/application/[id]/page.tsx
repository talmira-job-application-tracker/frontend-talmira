          ...
          {isAdmin && (
            <div className="mt-8 border-t pt-6">
             ...
             <div className="mt-6 flex flex-col sm:flex-row sm:justify-end gap-3">
               <button
                onClick={() => router.push(`/interview/schedule/${application._id}`)}
                className="px-4 py-2 rounded-xl bg-teal-700 text-white hover:bg-teal-500 transition w-full sm:w-auto"
              >
                Schedule Interview
              </button>
              <Button
